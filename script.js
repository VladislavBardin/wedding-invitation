...
const dialogSteps = [
  ...
  },
  {
    ...
    speaker: "groom",
    paragraphs: [
      "В этот день мы будем рады, если Вы поддержите атмосферу праздника своим образом.",
      "Пусть Ваш образ будет вечерним и торжественным — таким, каким и должен быть вечер, который хочется запомнить надолго."
    ],
  },
  {
    scene: "room",
    speaker: "bride",
    paragraphs: [
      "Костюм, платье, жакет, благородные оттенки, красивые ткани и, быть может, немного той самой вневременной элегантности — всё будет к месту.",
    ],
  },
  {
    scene: "garden",
